...
Import-Module .\source\packages\psake.4.7.4\tools\psake\psake.psm1
...
Invoke-Psake .\default.ps1 $task -framework "4.7.2x64" -properties @{ buildNumber=$buildNumber; preRelease=$preRelease }
